...
import { GridDots, VerticalStripes } from './DecorativeElements';
import { Sparkles, Pill, HeartPulse, Activity, Stethoscope, Droplet, Shield } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        <FadeIn>
          ...
          <h1 className="flex flex-col">
            ...
            <span className="relative font-heading text-[72px] md:text-[100px] lg:text-[120px] 
            ...
            <span className="relative font-script italic text-lime 
                   text-[80px] md:text-[100px] lg:text-[120px] 
                   leading-[0.8] -mt-2 md:-mt-6 ml-0 md:ml-12
                   drop-shadow-[0_0_30px_rgba(200,230,120,0.5)]">
              Anti
            </span>

            {/* Baris 3: KOLESTEROL — putih solid */}
            <span className="font-heading text-[72px] md:text-[100px] lg:text-[120px] 
                   text-white uppercase leading-[0.9] tracking-tight
          ...
          {/* ---------- SUBTITLE ---------- */}
          <div className="flex items-center gap-3 mt-4 mb-6 opacity-80">
            <div className="w-8 h-[1px] bg-lime/60" />
          </div>

          {/* ---------- DESKRIPSI ---------- */}
          <p className="font-sans text-cream text-lg max-w-[480px] mt-2 mb-10 
                        leading-relaxed opacity-90
                        animate-fade-slide">
            Edukasi komprehensif tentang <strong className="text-lime">obat anti kolesterol</strong> —
            golongan obat yang bekerja menurunkan LDL & trigliserida, serta menjaga HDL
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              <span className="inline-flex items-center gap-2">
                <HeartPulse className="w-4 h-4 group-hover:scale-125 transition-transform duration-500" />
                Lihat Tim
              </span>
            </a>
          </div>
          ...
          {/* ---------- SCROLL INDICATOR ---------- */}
          <div className="mt-16 hidden lg:flex items-center gap-4 opacity-60">
